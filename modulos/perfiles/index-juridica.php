...
<nav>
    <div class="nav nav-tabs" id="nav-tab" role="tablist" >
        ...
        Datos de domicilio<span id="agregardom" data-placement="top" title="Agregar domicilio" data-toggle="tooltip"><button type="button"  class="domicilio-add btn btn-outline-success" data-toggle="modal" data-target="#agregardomicilio" personaid="<?php echo $personaid?>"><i class="fas fa-plus"></i></button>
                        </span>
        </a>
    </div>
</nav>
